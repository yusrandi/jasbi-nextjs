            ...
            <div className="grid">
                <div className="col-12">
                    <div className="card docs">
                        ...
                        <p>
                            Next step is running the application using the start script and navigate to <b>https://api.jasbiapp.site/</b> to view the application. That is it, you may now start with the development of your application using the Sakai
                            template.
                        </p>
